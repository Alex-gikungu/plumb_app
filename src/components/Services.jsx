...
const Services = () => {
  return (
    ...
    <div className="main">
      ...
      <div className="image">
        <img src="./pointing.jpeg" alt="image"/>
        <h2>Pointing Installation</h2>
        <p> we offer pointing  installations. To under construction sites whether large or small scale and perfect more than expected.
             We make sure that all our work is done to the highest standards of safety and efficiency.</p>
      </div>
